...
QT_INIT_METAOBJECT const QMetaObject block::staticMetaObject = {
    { &QGraphicsObject::staticMetaObject, qt_meta_stringdata_block.data,
...
QT_MOC_LITERAL(1, 6, 11), // "boardChange"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 12), // "needNewBlock"
QT_MOC_LITERAL(4, 32, 12), // "gameFinished"
QT_MOC_LITERAL(5, 45, 11), // "moveOneStep"
QT_MOC_LITERAL(6, 57, 10), // "startTimer"
QT_MOC_LITERAL(7, 68, 8), // "interval"
QT_MOC_LITERAL(8, 77, 9) // "stopTimer"

    },
    "board\0boardChange\0\0needNewBlock\0"
    "gameFinished\0moveOneStep\0startTimer\0"
    "interval\0stopTimer"
};
#undef QT_MOC_LITERAL
...
void board::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->boardChange(); break;
        case 1: _t->needNewBlock(); break;
        case 2: _t->gameFinished(); break;
        case 3: _t->moveOneStep(); break;
        ...
        {
            using _t = void (board::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&board::boardChange)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (board::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&board::needNewBlock)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (board::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&board::gameFinished)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void board::boardChange()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void board::needNewBlock()
{
